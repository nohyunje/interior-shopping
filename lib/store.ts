...
const initial:Database={
 ...
 settings:{siteName:'MORUM',logoUrl:'',faviconUrl:'',heroTitle:'마음에 드는 공간을 둘러보고',heroDescription:'마음에 드는 가구를 바로 만나보세요.',seoTitle:'MORUM | 공간을 쇼핑하다',seoDescription:'공간을 둘러보고 마음에 드는 가구를 바로 만나보세요.',ogImage:defaultImage,footerText:'공간을 보고, 가구를 발견하는 새로운 방식',serviceStatus:'live',adminId:process.env.ADMIN_ID||'admin',adminPasswordHash:hashPassword(process.env.ADMIN_PASSWORD||'change-me-now')},
